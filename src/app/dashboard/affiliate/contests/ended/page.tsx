...
const EndedContestsPage = () => {
  ...
  const { endedContests: backendContests, userParticipations, loading, error } = useContests()
  ...
  const endedContests: Contest[] = backendContests.map((contest: any, index: number) => {
    ...
    return {
      ...
      prizeWon: participation?.prize_won || 'N/A',
      status: 'Ended',
  ...
  const filteredContests = endedContests.filter(contest =>
    ...
    contest.prizeWon.toLowerCase().includes(searchQuery.toLowerCase())
  )
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span className="ml-2 font-semibold text-gray-700">#{contest.yourRank || 'N/A'}</span>
                  </div>
                </div>
                  ...
                  <div className="mb-6 space-y-4">
                    ...
                    <div className="border border-gray-200 rounded p-4 bg-gray-50">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        This contest offered multiple prize tiers based on sales performance. Participants could earn cash rewards 
                        and physical prizes for reaching different sales milestones.
                      </p>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded p-4 bg-gray-50">
                      ...
                      <ul className="list-disc pl-4 space-y-1 text-gray-600 text-sm">
                        ...
                        <li>Only new affiliate sign-ups during the contest period were eligible</li>
                        <li>Multiple entries from the same referred affiliate were not counted</li>
                        <li>Prizes were awarded based on cumulative sales at the end of the contest period</li>
                        <li>Prize winners were notified via email and had 30 days to claim their prizes</li>
                      </ul>
                    </div>
